// =========================
// API KEYS - النسخة النضيفة بدون اعلانات
// =========================
...
// =========================
// EMBED - كل السيرفرات النضيفة بدون Melbet ads
// =========================
...
export const EMBED_SERVERS = {
  ...
  // خلينا VidSrc.to كاختيار اخير بس عشان لو كله وقع
  vidsrc_to: {
    name: 'VidSrc.to (فيه اعلانات)',
...
// للتوافق مع الكود القديم - خلي الافتراضي نضيف
...
export const api = {
  ...
  seasonDetails: (id, season) => tmdbFetch(`/tv/${encodeURIComponent(id)}` + `/season/${encodeURIComponent(season)}`),
}

// =========================
// MOVIE EMBED - النضيف بدون اعلانات Melbet
// =========================
export function movieEmbedUrl(tmdbId) {
  // غيرتها من vidsrc.to لـ multiembed اللي بدون اعلانات
  return `https://multiembed.mov/?video_id=${tmdbId}&tmdb=1`
}

// =========================
// TV EMBED - النضيف بدون اعلانات
// =========================
